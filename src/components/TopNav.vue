<template>
    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false">
        <el-menu-item>
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
                <path fill="currentColor"
                    d="M4 2.997h16a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1m2 9h6a1 1 0 0 1 1 1v3h1v6h-4v-6h1v-2H5a1 1 0 0 1-1-1v-2h2zm11.732 1.732L19.5 11.96l1.768 1.768a2.5 2.5 0 1 1-3.536 0" />
            </svg>
            <h1>quickCanvas</h1>
        </el-menu-item>
        <el-menu-item>
            <el-link href="https://github.com/guihuala/quickCanvas">
        ...
        <el-sub-menu index="2">
            <template #title>
                画布</template>
            <el-menu-item index="2-1" @click="changeCanvasSize('small')">小 (640x480)</el-menu-item>
            <el-menu-item index="2-2" @click="changeCanvasSize('medium')">中 (800x600)</el-menu-item>
            <el-menu-item index="2-3" @click="changeCanvasSize('large')">大 (1024x768)</el-menu-item>
        </el-sub-menu>
    </el-menu>
</template>
...
const emit = defineEmits(['changeCanvasSize'])

const activeIndex = ref('1')

// 用于处理画布大小更改的事件
const changeCanvasSize = (size: string) => {
    emit('changeCanvasSize', size);
}
</script>
